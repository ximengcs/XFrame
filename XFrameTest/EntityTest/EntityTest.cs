    ...
    public class EntityTest
    {
        ...
        public void Test1()
        {
            EntryTest.Exec(100, () =>
            {
                ...
                E1 e1 = XModule.Entity.Create<E1>((db) =>
                {
        ...
        public void Test2()
        {
            EntryTest.Exec(100, () =>
            {
                E1 e1 = XModule.Entity.Create<E1>((entity) =>
                {
        ...
        public void Test3()
        {
            EntryTest.Exec(50, () =>
            {
                XModule.Entity.RegisterEntity<EBase>();
                EBase c3 = XModule.Entity.Create<EBase>(3);
            });
        }
